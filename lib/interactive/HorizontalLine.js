...
var HorizontalLine = function (_Component) {
	...
	_createClass(HorizontalLine, [{
		key: "handleDragLine",
		value: function handleDragLine(index, newXYValue, otherProps) {
			this.setState({
		...
		value: function getHoverInteractive(hovering, horizontalLine) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				trends.map(function (each, idx) {
					...
					var hoverTextWithDefault = _extends({}, HorizontalLine.defaultProps.hoverText, hoverText);
					return _react2.default.createElement(_EachHorizontalLine2.default, {
						...
						getHoverInteractive: function getHoverInteractive(hovering) {
							return _this4.getHoverInteractive(hovering, each);
						}
					});
				}),
				tempLine,
