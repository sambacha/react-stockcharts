...
var _EachFreeArrows = require("./wrapper/EachFreeArrows");

var _EachFreeArrows2 = _interopRequireDefault(_EachFreeArrows);
...
var FreeArrows = function (_Component) {
	_inherits(FreeArrows, _Component);

	function FreeArrows(props) {
		_classCallCheck(this, FreeArrows);

		var _this = _possibleConstructorReturn(this, (FreeArrows.__proto__ || Object.getPrototypeOf(FreeArrows)).call(this, props));
		...
		_this.getSelectionState = (0, _utils2.isHoverForInteractiveType)("arrows").bind(_this);
	...
	_createClass(FreeArrows, [{
		...
		value: function handleDragLineComplete(moreProps) {
			...
			if ((0, _utils.isDefined)(override)) {
				...
				var newArrows = arrows.map(function (each, idx) {
				...
				this.setState({
					...
					_this2.props.onComplete(newArrows, moreProps);
				});
			}
		}
	}, {
		...
		value: function handleEnd(xyValue, moreProps, e) {
			...
			if (this.mouseMoved && (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.start)) {
				...
				var newArrows = [].concat(_toConsumableArray(arrows.map(function (d) {
				...
				this.setState({
					...
					_this4.props.onComplete(newArrows, moreProps, e);
				});
			}
		}
	}, {
		...
		value: function render() {
			...
			var tempLine = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end) ? _react2.default.createElement(_Arrows2.default, {
				type: type,
				noHover: true,
			...
			return _react2.default.createElement(
				"g",
				null,
				arrows.map(function (each, idx) {
					var eachAppearance = (0, _utils.isDefined)(each.appearance) ? _extends({}, appearance, each.appearance) : appearance;

					var hoverTextWithDefault = _extends({}, FreeArrows.defaultProps.hoverText, hoverText);

					return _react2.default.createElement(_EachFreeArrows2.default, {
						key: idx,
						...
						strokeWidth: getAppearance(type, eachAppearance).strokeWidth,
						strokeOpacity: getAppearance(type, eachAppearance).strokeOpacity,
						strokeDasharray: getAppearance(type, eachAppearance).strokeDasharray,
...
FreeArrows.propTypes = {
	...
	type: _propTypes2.default.oneOf(["ARROW", // extends from -Infinity to +Infinity
	"ARROW-OPEN", // extends to +/-Infinity in one direction
	"ARROW-CLOSE"] // extends between the set bounds
	),
	hoverText: _propTypes2.default.object.isRequired,

	arrows: _propTypes2.default.array.isRequired,
	...
	appearance: _propTypes2.default.shape({
		...
		arrow: _propTypes2.default.shape({
...
exports.default = FreeArrows;
//# sourceMappingURL=FreeArrows.js.map