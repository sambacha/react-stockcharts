...
var ClickableRect = function (_Component) {
	_inherits(ClickableRect, _Component);

	function ClickableRect(props) {
		_classCallCheck(this, ClickableRect);

		var _this = _possibleConstructorReturn(this, (ClickableRect.__proto__ || Object.getPrototypeOf(ClickableRect)).call(this, props));
...
exports.default = ClickableRect;
//# sourceMappingURL=ClickableRect.js.map