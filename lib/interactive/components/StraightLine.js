...
function getHorizontalCoordinates(_ref10) {
	...
	var _xScale$domain5 = xScale.domain(),
	    _xScale$domain6 = _slicedToArray(_xScale$domain5, 2),
	    xBegin = _xScale$domain6[0],
	    xFinish = _xScale$domain6[1];

	var _yScale$domain5 = yScale.domain(),
	    _yScale$domain6 = _slicedToArray(_yScale$domain5, 2),
	    yBegin = _yScale$domain6[0],
	    yFinish = _yScale$domain6[1];
