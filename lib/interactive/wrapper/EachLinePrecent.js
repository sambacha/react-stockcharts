...
var EachLinePrecent = function (_Component) {
	_inherits(EachLinePrecent, _Component);

	function EachLinePrecent(props) {
		_classCallCheck(this, EachLinePrecent);

		var _this = _possibleConstructorReturn(this, (EachLinePrecent.__proto__ || Object.getPrototypeOf(EachLinePrecent)).call(this, props));
		...
		_this.state = {
			...
			percent: "",
			move: false,
			Edge1DItem: _this.props.firstItem,
			Edge2DItem: _this.props.lastItem
		};
		return _this;
	}

	_createClass(EachLinePrecent, [{
		...
		value: function handleLineDrag(moreProps) {
			...
			if ((0, _utils.isDefined)(mouseXY)) {
				...
				onDrag(index, {
					...
					x2Value: newX2Value,
					y2Value: newY2Value,
					firstItem: fullData.find(function (item) {
						return item.idx.index === newX1Value;
					}),
					lastItem: fullData.find(function (item) {
						return item.idx.index === newX2Value;
					})
				});
				this.setState({
					anchor: "edge1",
					move: true,
					Edge1DItem: fullData.find(function (item) {
						return item.idx.index === newX1Value;
					}),
					Edge2DItem: fullData.find(function (item) {
						return item.idx.index === newX2Value;
					})
				});
			}
		...
		value: function handleEdge2DragStart(moreProps) {
			this.setState({
				anchor: "edge2",
				move: true,
		...
		value: function handleEdge1Drag(moreProps) {
			...
			var _state = this.state,
			    Edge1DItem = _state.Edge1DItem,
			    Edge2DItem = _state.Edge2DItem;
		...
		value: function handleEdge2Drag(moreProps) {
			...
			var _state2 = this.state,
			    Edge1DItem = _state2.Edge1DItem,
			    Edge2DItem = _state2.Edge2DItem;
		...
		value: function render() {
			...
			var percentFormat = (0, _d3Format.format)(".2%");

			var _state3 = this.state,
			    hover = _state3.hover,
			    anchor = _state3.anchor;
			var _state4 = this.state,
			    Edge1DItem = _state4.Edge1DItem,
			    Edge2DItem = _state4.Edge2DItem;
			...
			var xyProvider = function xyProvider(_ref) {
				...
				var x = xScale((x1 + x2) / 2) + 30;
				var y = yScale((y1 + y2) / 2) + 20;
				return [x, y];
			};
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					Edge1DItem && Edge2DItem ? percentFormat((y2Value - y1Value) / y2Value) : "0%"
				),
		...
		value: function getDerivedStateFromProps(nextProps, prevState) {
			if ((prevState.Edge1DItem !== nextProps.firstItem || prevState.Edge2DItem !== nextProps.lastItem) && prevState.move === false) {
				return {
...
exports.default = EachLinePrecent;
//# sourceMappingURL=EachLinePrecent.js.map