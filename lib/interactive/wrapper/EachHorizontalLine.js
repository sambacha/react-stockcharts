...
var EachHorizontalLine = function (_Component) {
	...
	function EachHorizontalLine(props) {
		...
		_this.state = {
			hover: false,
			anchor: undefined,
			width: (_this.props.x1Value + _this.props.x2Value) / 2
		};
		return _this;
	}
	...
	_createClass(EachHorizontalLine, [{
		...
		value: function handleDragComplete() {
			...
			(_props4 = this.props).onDragComplete.apply(_props4, arguments);
		}
	}, {
		key: "handleEdge1Drag",
		value: function handleEdge1Drag(moreProps) {
			...
			var _dragStart2 = this.dragStart,
			    x1Value = _dragStart2.x1Value,
			    y1Value = _dragStart2.y1Value,
			    x2Value = _dragStart2.x2Value,
			    y2Value = _dragStart2.y2Value;
			var yScale = moreProps.chartConfig.yScale;
			var startPos = moreProps.startPos,
			    mouseXY = moreProps.mouseXY;
		...
		value: function render() {
			var _props6 = this.props,
			    ...
			    x2Value = _props6.x2Value,
			    y2Value = _props6.y2Value,
			    type = _props6.type,
			    ...
			    edgeInteractiveCursor = _props6.edgeInteractiveCursor,
			    lineInteractiveCursor = _props6.lineInteractiveCursor,
