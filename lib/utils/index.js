...
exports.dxCalculation = dxCalculation;
exports.adxCalculation = adxCalculation;
exports.plusDICalculation = plusDICalculation;
exports.minusDICalculation = minusDICalculation;
exports.trSmoothCalculation = trSmoothCalculation;
exports.plusDMSmoothCalculation = plusDMSmoothCalculation;
exports.minusDMSmoothCalculation = minusDMSmoothCalculation;
exports.plusDMCalculation = plusDMCalculation;
exports.minusDMCalculation = minusDMCalculation;
...
function current(array, accessor) {
	var lastTick = void 0,
	    obvs = [],
	    length = array.length,
	    value = 0;
...
function plusDMCalculation(currentHigh, previousHigh, currentLow, previousLow) {
	var highDiff = currentHigh - previousHigh;
	var lowDiff = previousLow - currentLow;
	if (highDiff > lowDiff) {
		return (0, _d3Array.max)([highDiff, 0]);
	}
	return 0;
}
...
function minusDMCalculation(currentHigh, previousHigh, currentLow, previousLow) {
	...
	if (lowDiff > highDiff) {
		return (0, _d3Array.max)([lowDiff, 0]);
	}
	return 0;
}
