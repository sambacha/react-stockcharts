	...
	_createClass(OHLCTooltip, [{
		...
		value: function renderSVG(moreProps) {
			...
			var _props = this.props,
			    ...
			    lastAsDefault = _props.lastAsDefault;
			...
			var displayItem = lastAsDefault ? currentItem || (0, _utils.last)(fullData) : currentItem;
			...
			if ((0, _utils.isDefined)(displayItem) && (0, _utils.isDefined)(accessor(displayItem))) {
				var item = accessor(displayItem);
...
OHLCTooltip.propTypes = {
	...
	lastAsDefault: _propTypes2.default.bool
};
