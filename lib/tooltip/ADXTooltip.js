...
var ADXTooltip = function (_Component) {
	_inherits(ADXTooltip, _Component);

	function ADXTooltip(props) {
		_classCallCheck(this, ADXTooltip);

		var _this = _possibleConstructorReturn(this, (ADXTooltip.__proto__ || Object.getPrototypeOf(ADXTooltip)).call(this, props));

		_this.renderSVG = _this.renderSVG.bind(_this);
		return _this;
	}

	_createClass(ADXTooltip, [{
		key: "renderSVG",
		value: function renderSVG(moreProps) {
			...
			var adx = (0, _utils.isDefined)(currentItem) && yAccessor(currentItem);
			var plusDI = adx && displayFormat(adx.plusDI) || "n/a";
			var minusDI = adx && displayFormat(adx.minusDI) || "n/a";
			var adxVal = adx && displayFormat(adx.adxValue) || "n/a";
			...
			var tooltipLabel = "ADX (" + options.windowSize + "): ";
			var plusDILabel = "DIP (" + options.windowSize + "): ";
			var minusDILabel = "DIM (" + options.windowSize + "): ";
...
exports.default = ADXTooltip;
//# sourceMappingURL=ADXTooltip.js.map